...
public class BlackjackGUITESTER extends JFrame{
	...
	pane.setLayout(new FlowLayout(-2,0,0));
  ...
  ImageIcon imageIcon3 = new ImageIcon("img/" + game.dealer.getHand()[0].img);
	Image image3 = imageIcon2.getImage();
	Image newimg3 = image3.getScaledInstance(120, 180,  java.awt.Image.SCALE_SMOOTH);
	imageIcon3 = new ImageIcon(newimg2);

  pane.add(new JLabel(imageIcon1));
	pane.add(new JLabel(imageIcon2));
  pane.add(new JLabel(imageIcon3));


    }

    public static void main(String[] args) {
	BlackjackGUITESTER b = new BlackjackGUITESTER();
	b.setVisible(true);
    }
